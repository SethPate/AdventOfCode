# WARNING: this takes too much time to run. i need to make the recursion more efficient.
...
#take a prompt and return the first value generated by a method that is higher than the prompt
...
for i in range(60, 65): #start with 0 but stop if you get to the a certain point; tell me the answer
    if r(i) > prompt:
        print(r(i))
